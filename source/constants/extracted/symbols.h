...
static const size_t Count = 94UL;
...
enum Id
{
	...
	IdMinPointScale                      = 62,
	IdModelView                          = 63,
	IdMotionPointBasedRenderer           = 64,
	IdMotionSpeed                        = 65,
	IdMotionTime                         = 66,
	IdMotionTransform                    = 67,
	IdObject                             = 68,
	IdOpenGLContext                      = 69,
	IdParamSet                           = 70,
	IdParticleColor                      = 71,
	IdParticleDensity                    = 72,
	IdParticleRadius                     = 73,
	IdPointScale                         = 74,
	IdProjection                         = 75,
	IdRawFileLog                         = 76,
	...
	IdScreenSize                         = 78,
	IdShader                             = 79,
	IdSmoothingRadius                    = 80,
	IdSmoothingScale                     = 81,
	IdSphPointBasedRenderer              = 82,
	IdStreamLog                          = 83,
	IdSymbolRegistry                     = 84,
	IdThread                             = 85,
	IdTiledRenderer                      = 86,
...
Table[] = 
{
	...
	vd::symbol( Keys[ IdGadgetDataFile ], Strings[ IdGadgetDataFile ] ),
