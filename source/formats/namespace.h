...
#define VD_FORMATS_NAMESPACE_BEGIN(x)    VD_FORMATS_NAMESPACE_ENTER { struct EnterFormatsNamespace
#define VD_FORMATS_NAMESPACE_END(x)      VD_FORMATS_NAMESPACE_EXIT } struct ExitFormatsNamespace
