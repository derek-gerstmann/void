...
#define VD_GRAPHICS_OPENGL_NAMESPACE_BEGIN(x)    VD_GRAPHICS_OPENGL_NAMESPACE_ENTER { enum { }
#define VD_GRAPHICS_OPENGL_NAMESPACE_END(x)      VD_GRAPHICS_OPENGL_NAMESPACE_EXIT } enum { }
