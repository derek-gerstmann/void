...
- (void)awakeFromNib
{
    ...
    self.frame = NSMakeRect(0, 0, vdGetWindowConfig().Width, vdGetWindowConfig().Height);
...
- (void)drawRect:(NSRect)rect
{
    ...
    if (!m_didInit) {
        ...
        [[self window] setTitle: [NSString stringWithUTF8String: vdGetWindowConfig().Title]];
    }
