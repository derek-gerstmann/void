...
#define VD_INTERFACE_GLUT_NAMESPACE_BEGIN(x)    VD_INTERFACE_GLUT_NAMESPACE_ENTER { struct EnterGlutNamespace
#define VD_INTERFACE_GLUT_NAMESPACE_END(x)      VD_INTERFACE_GLUT_NAMESPACE_EXIT } struct ExitGlutNamespace
