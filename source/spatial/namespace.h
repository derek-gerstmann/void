...
#define VD_SPATIAL_NAMESPACE_BEGIN(x)    VD_SPATIAL_NAMESPACE_ENTER { struct EnterSpatialNamespace
#define VD_SPATIAL_NAMESPACE_END(x)      VD_SPATIAL_NAMESPACE_EXIT } struct ExitSpatialNamespace
